...
import com.rabbitrock.screens.transitions.ScreenTransitionFade;
...
private Table buildOptWinAudioSettings () {  
	...
	sldSound = new Slider(0.0f, 1.0f, 0.1f, false, skinLibgdx);  tbl.add(sldSound);
	tbl.row();  // + Checkbox, "Music" label, music volume slider
	chkMusic = new CheckBox("", skinLibgdx); 
	tbl.add(chkMusic); 
	tbl.add(new Label("Music", skinLibgdx)); 
	sldMusic = new Slider(0.0f, 1.0f, 0.1f, false, skinLibgdx); 
	tbl.add(sldMusic);  tbl.row();  return tbl;
>>>>>>> Stashed changes
	}
